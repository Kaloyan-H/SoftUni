...
namespace EntityFrameworkIntroLab.Data
{
    public partial class SoftUniContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server = localhost; Database = SoftUni;User Id = sa;Password = sa;Trust Server Certificate = true");
            }
        }
